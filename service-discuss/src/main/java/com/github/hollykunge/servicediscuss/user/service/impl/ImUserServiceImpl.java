...
import com.github.hollykunge.servicediscuss.user.entity.*;
import com.github.hollykunge.servicediscuss.user.mapper.ImUserMapper;
import com.github.hollykunge.servicediscuss.user.service.IImChatGroupUserService;
...
import com.github.hollykunge.servicediscuss.user.service.IImUserService;
...
public class ImUserServiceImpl extends ServiceImpl<ImUserMapper, ImUser> implements IImUserService {
    ...
    @Value("${lark.im.admin.id}")
    private String adminId;

    @Value("${lark.im.default.chat.id}")
