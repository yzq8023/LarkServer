...
//	int saveFile(ChatFileModel chatFile);
	 ...
	 * @return
	 */
//	int saveTools(ToolsModel tools);
	 ...
	 * @return
	 */
//	int updateTools(ToolsModel tools);

	/**
	 * 获得组织架构的树形结构
	 * @return
	 */
//	List<TreeModel> queryAllOrgTree();
	 ...
	 * @return
	 */
//	public List<FileModel> queryFilePage(List<String> fileList, @Param("fileName") String fileName, @Param("start") int start, @Param("rows") int rows);

	/**
	 * 分页查询时获得文件组总数
	 * @return
	 */
	public int queryFilePageCount(@Param("fileName") String fileName);
...
//	List<ReModel> queryReMsg();
	 ...
	 */
//	List<ChatFileModel> queryUList(@Param("start") Integer start, @Param("row") Integer row,
//                                   @Param("fileName") String fileName, @Param("sendUser") String sendUser, @Param("fileLevels") String fileLevels);
	 ...
	 * @return
	 */
	int queryUCount(@Param("fileName") String fileName, @Param("sendUser") String sendUser, @Param("fileLevels") String fileLevels);
	 ...
	 * @param sendUser
	 * @param fileLevels
	 * @return	:List<ChatFileModel>
	 */
//	List<ChatFileModel> queryGList(@Param("start") Integer start, @Param("row") Integer row,
//                                   @Param("fileName") String fileName, @Param("sendUser") String sendUser, @Param("fileLevels") String fileLevels);
	 ...
	 * @return
	 */
//	List<StatisticsModel> queryMsgCount(@Param("sender") String sender);
	 ...
	 * @return
	 */
//	List<Content> queryMsgContent(@Param("sender") String sender, @Param("receiver") String receiver);
	 ...
	 * @return
	 */
//	ReportDataModel getReportData(String userid);
	 ...
	 * @return
	 */
	List<ATModel> getAtUser(@Param("groupId") String groupId, @Param("userId") String userId);
