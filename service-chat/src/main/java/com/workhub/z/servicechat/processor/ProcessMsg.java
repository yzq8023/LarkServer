...
public class ProcessMsg extends AbstractMsgProcessor{
    ...
    public Object process(ChannelContext channelContext, String msg) {
        try{
            ...
            //文件上传信息更新begin
            try {
                String msgType = common.nulToEmptyString(common.getJsonStringKeyValue(msg,"content.type"));
                //如果是文件或者图片上传
                if("2".equals(msgType)||"3".equals(msgType)){
                    String fileId = common.nulToEmptyString(common.getJsonStringKeyValue(msg,"content.id"));
                    String level = common.nulToEmptyString(common.getJsonStringKeyValue(msg,"content.secretLevel"));
                    String receiverId = common.nulToEmptyString(common.getJsonStringKeyValue(msg,"toId"));
                    zzGroupFileService.fileUpdate(fileId,receiverId,level);
                }
            } catch (Exception e) {
                //异常记录到日志
